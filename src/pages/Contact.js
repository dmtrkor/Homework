...
class Contact extends React.Component {
    componentDidMount() {
        document.getElementById('headerBG').style.backgroundImage = "url('/assets/img/contact-bg.jpg')";
        document.getElementById('headerText').innerText = "Contact Me"
        document.getElementById('headerSpan').innerText = "Have questions? I have answers."
