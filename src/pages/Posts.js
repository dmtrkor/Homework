...
class Posts extends React.Component {
    componentDidMount() {
        document.getElementById('headerBG').style.backgroundImage = "url('/assets/img/post-bg.jpg')";
        document.getElementById('headerText').innerText = "Man must explore, and this is exploration at its greatest"
        document.getElementById('headerSpan').innerText = "Problems look mighty small from 150 miles up"
        document.getElementById('headerPost').innerText = 'Posted by Start Bootstrap on August 24, 2022 '
                    ...
                    <div className="row gx-4 gx-lg-5 justify-content-center">
                        <div className="col-md-10 col-lg-8 col-xl-7">
                            ...
                            <p>Science cuts two ways, of course; its products can be used for both good and evil. But
                                ...
                                also come from science.</p>
                            <p>What was most significant about the lunar voyage was not that man set foot on the Moon
                                but that they set eye on the earth.</p>
                            ...
                            <p>For those who have seen the Earth from space, and for the hundreds and perhaps thousands
                                ...
                                we share in our world are far more valuable than those which divide us.</p>
                            ...
                            <a href="#!"><img className="img-fluid" src="assets/img/post-sample-image.jpg"
                                              alt="..."/></a>
                            ...
                            <p>Space, the final frontier. These are the voyages of the Starship Enterprise. Its
                                ...
                                civilizations, to boldly go where no man has gone before.</p>
